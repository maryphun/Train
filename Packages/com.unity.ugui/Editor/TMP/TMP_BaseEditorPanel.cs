...
namespace TMPro.EditorUtilities
{
    public abstract class TMP_BaseEditorPanel : Editor
    {
        ...
        protected SerializedProperty m_IsDynamicFontProp;
        protected SerializedProperty m_IsDialogProp;
        protected SerializedProperty m_LocalizeID;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_IsDynamicFontProp = serializedObject.FindProperty("m_isDynamicFont");
            m_IsDialogProp =  serializedObject.FindProperty("m_isDialog");
            m_LocalizeID =  serializedObject.FindProperty("m_localizeID");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_IsDynamicFontProp, new GUIContent("Is Dynamic Font"));
            EditorGUILayout.PropertyField(m_IsDialogProp, new GUIContent("Is Dialog"));
            EditorGUILayout.PropertyField(m_LocalizeID, new GUIContent("Localize ID"));
