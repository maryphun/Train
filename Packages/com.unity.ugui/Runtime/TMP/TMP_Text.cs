...
namespace TMPro
{
    ...
    {
        public static System.Func<string, string> LocalizationResolver;
        ...
        public virtual string text
        {
            get
            {
                if (!string.IsNullOrEmpty(m_localizeID) && LocalizationResolver != null)
                {
                    return LocalizationResolver(m_localizeID);
                }
            ...
            set
            {
                if (m_IsTextBackingStringDirty == false &&
                    m_text != null &&
                    value != null &&
        ...
        {
            // Do not modify TMP text while editing scenes or prefabs.
            if (!Application.isPlaying)
                return;

            if (string.IsNullOrEmpty(m_localizeID))
                return;

            if (LocalizationResolver == null)
                return;

            string localizedValue = LocalizationResolver(m_localizeID);
        ...
        [SerializeField] protected bool m_isDynamicFont = true;
        [SerializeField] protected bool m_isDialog = false;
        [SerializeField] protected string m_localizeID = string.Empty;
